...
CREATE USER '<dev user>' PASSWORD '<password>';

-- authorize access to SYS views
GRANT CATALOG READ TO '<dev user>';

-- authorize creation & removal of PAL procedures
GRANT AFLPM_CREATOR_ERASER_EXECUTE TO '<dev user>';

-- authorize execution of PAL procedures
GRANT AFL__SYS_AFL_AFLPAL_EXECUTE TO '<dev user>';
